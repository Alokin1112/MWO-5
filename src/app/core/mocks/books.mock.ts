...
export const BOOKS_MOCK: BookDTO[] = [
  ...
  { id: 8, title: 'Harry Potter and the Sorcerer\'s Stone', author: AUTHORS_MOCK[7], pageCount: 400, price: 29.99, photoUrl: 'url8' },
  ...
  { id: 31, title: 'The Hitchhiker\'s Guide to the Galaxy', author: AUTHORS_MOCK[10], pageCount: 280, price: 18.99, photoUrl: 'url31' },
